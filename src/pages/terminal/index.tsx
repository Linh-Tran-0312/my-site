...
const blogs = [
    ...
    { title: 'Learning React', description: 'My journey learning React and its ecosystem.' },
    { title: 'Mastering CSS', description: 'Tips and tricks for CSS layouts and styling.' },
  ];
const TerminalPage = () => {

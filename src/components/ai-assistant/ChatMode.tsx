...
import { faUpRightAndDownLeftFromCenter, faXmark, faPaw } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    ...
    <div className='position-relative d-flex flex-column'>
        ...
        <div className='d-flex'>
          <Button size='sm' variant='light'><Icon icon={faUpRightAndDownLeftFromCenter}/></Button>
          <Button size='sm' variant='light' className='ms-2' onClick={() => setMode(MODE.SLEEPING)}><Icon icon={faXmark}/></Button>
        </div>
        </div>
      </div>
